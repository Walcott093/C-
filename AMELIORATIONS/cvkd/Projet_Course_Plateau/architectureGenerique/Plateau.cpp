...
Plateau::Plateau(Jeu* j, int rangeOrd, int rangeAbs):
  ...
  if(plateauNomJeu == ECHELLE_SERPENT
    ...
    for(int i=0 ; i<nbCases ; i++)
      plateau[i] = new CaseEchelleSerpent(i, nbPionsMax, 0, (EchelleSerpent*)jeu, NEUTRE); // On met la specificite de la case a NEUTRE et elle se chagera de changer sa specificite en fonction des parametres pertinents (nbCasesNonNeutres, etc.)
