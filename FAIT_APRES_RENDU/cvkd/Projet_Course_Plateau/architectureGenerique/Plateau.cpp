...
ostream& operator<<(ostream& o,Plateau& p){
  ...
  for(int i=p.getNbCases() ; i>=1 ; i-=p.getNbColonnes()) {
	...
	if(nomJeu == ECHELLE_SERPENT
	  ...
	  CaseEchelleSerpent* ces1 = (CaseEchelleSerpent*)p.plateau[i -c -1];
	  o << ces1;
	}
	/*
	else if(nomJeu == CARTAGENA) {
	  CaseCartagena* cc1 = (CaseCartagena*)p.plateau[i -c -1];
	  o << cc1;
	  }*/
	else
	  o << (p.plateau[i -c -1]);
	...
	if(nomJeu == ECHELLE_SERPENT
	   ...
	   || nomJeu == ECHELLE_SERPENT_PEDAGOGIQUE
	   || nomJeu == ECHELLE_SERPENT_PLUSIEURS_PIONS) {
	  CaseEchelleSerpent* ces2 = (CaseEchelleSerpent*)p.plateau[i -c -1];
	  o << ces2 << "|";
	}
	/*
	else if(nomJeu == CARTAGENA) {
	  CaseCartagena* cc2 = (CaseCartagena*)p.plateau[i -c -1];
	  o << cc2 << "|";
	  }*/
	else
	  o << (p.plateau[i -c -1]) << "|";
