...
public:
  ...
  Case(int, int, int, forward_list<Pion*>); // position, nbPionsMax, nbPions, listePions, obj  // Sert pour la premiere case ou se trouvent tous les pions au debut, ou pour modifier une case en cours de partie si un jeu le permet
